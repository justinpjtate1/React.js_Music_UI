...
class Playlist_container extends Component {
    render() {
        return(
            <>
            <Playlist_items addNewPlaylist={() => this.props.addNewPlaylist()} playlists={this.props.playlists} newPlaylistInput={(e) => this.props.newPlaylistInput(e)} playlistToDisplay={(e) => this.props.playlistToDisplay(e)}/>
